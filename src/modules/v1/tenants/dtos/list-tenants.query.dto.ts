...
export class ListTenantsQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Search by English or Arabic name (case-insensitive contains)',
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({ enum: ['nameEn', 'createdAt'], default: 'createdAt' })
  @IsOptional()
  @IsIn(['nameEn', 'createdAt'])
